...
TEST_ITEM = "live-rtmp-ingest-h264-crf-aac-fmp4-hls-dash"
...
def main():
    ...
    print(f"Live encoding is up and ready for ingest. RTMP URL: rtmp://{live_encoding.encoder_ip}/live StreamKey: {live_encoding.stream_key}"
          )

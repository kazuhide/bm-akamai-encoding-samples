...
TEST_ITEM = "vod-h264-aac-fmp4-drm-cbc-hls-dash-linode-object-storage-in-out"
...
def main():
    ...
    The steps include:
      1) Creating Generic S3 input/output for Linode Object Storage.
    ...
    # 1) Create Generic S3 Input/Output
